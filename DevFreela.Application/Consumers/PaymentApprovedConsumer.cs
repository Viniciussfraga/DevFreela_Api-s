...
{
    //Do mesmo jeito que temos essa classe no Microsserviço para processar o pagamento, teremos esse consumidor que receberá as info do pagamento processado.
    public class PaymentApprovedConsumer : BackgroundService
    {
        ...
        public async Task FinishProject(int id)
        {
            ...
            {
                var projectRepository = scope.ServiceProvider.GetRequiredService<IProjectRepository>(); //utilizado para obter o svç de injenção de dependência.
